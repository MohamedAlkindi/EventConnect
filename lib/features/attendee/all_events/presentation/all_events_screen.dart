...
import 'package:event_connect/core/widgets/attendee_widgets/confetti_effect.dart';
              ...
              childWidget:
                ...
                childWidget: Column(
                  ...
                  children: [
                    ...
                    mainAppBar(
                        context: context,
                        text: AppLocalizations.of(context)!.discoverEvents),
                          ...
                          return noEventsWidget(
                            ...
                            onPressed: () {
                              allEventsCubit.selectedCategory == "All"
                                  ? allEventsCubit.forceRefreshAllEvents()
                                  : allEventsCubit.forceRefreshCategoryEvents(
                                      category:
                                          allEventsCubit.selectedCategory);
                            },
                          );
                        }
                        return Column(
                          children: [
                            for (final event in snapshot.data!)
                              contentWidget(
                                context: context,
                                eventModel: event,
                                location: AllEventsCubit.getCityDisplay(
                                    event.location,
                                    AppLocalizations.of(context)!),
                                category: AllEventsCubit.getCategoryDisplay(
                                    event.category,
                                    AppLocalizations.of(context)!),
                                genderRestrection:
                                    AllEventsCubit.getGenderRestrictionDisplay(
                                        event.genderRestriction,
                                        AppLocalizations.of(context)!),
                                onTap: () {
                                  confettiController.play();
                                  myEventsCubit.getAndAddUserEvent(event);
